...
@zein_ubot(outgoing=True, disable_edited=True, pattern=r"^\.(d)?fban(?: |$)(.*)")
...
@zein_ubot(outgoing=True, disable_edited=True, pattern=r"^\.unfban(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.addf(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.delf$")
...
@zein_ubot(outgoing=True, pattern=r"^\.listf$")
...
@zein_ubot(outgoing=True, disable_edited=True, pattern=r"^\.clearf$")
