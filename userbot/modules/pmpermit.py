...
@zein_ubot(incoming=True, disable_edited=True, disable_errors=True)
...
@zein_ubot(disable_edited=True, outgoing=True, disable_errors=True)
...
@zein_ubot(outgoing=True, pattern=r"^\.notifoff$")
...
@zein_ubot(outgoing=True, pattern=r"^\.notifon$")
...
@zein_ubot(outgoing=True, pattern=r"^\.approve(?:$| )(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.disapprove(?:$| )(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.block$")
...
@zein_ubot(outgoing=True, pattern=r"^\.unblock$")
...
@zein_ubot(outgoing=True, pattern=r"^\.(set|get|reset) pmpermit(?: |$)(\w*)")
