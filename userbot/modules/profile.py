...
@zein_ubot(outgoing=True, pattern=r"^\.reserved$")
...
@zein_ubot(outgoing=True, pattern=r"^\.name")
...
@zein_ubot(outgoing=True, pattern=r"^\.setpfp$")
...
@zein_ubot(outgoing=True, pattern=r"^\.setbio (.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.username (.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.count$")
...
@zein_ubot(outgoing=True, pattern=r"^\.delpfp")
