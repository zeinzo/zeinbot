...
@zein_ubot(outgoing=True, pattern=r"^\.crblang (.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.carbon")
...
@zein_ubot(outgoing=True, pattern=r"^\.img(?: |$)(\d*)? ?(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.currency ([\d\.]+) ([a-zA-Z]+) ([a-zA-Z]+)")
...
@zein_ubot(outgoing=True, pattern=r"^\.google(?: |$)(\d*)? ?(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.ddg(?: |$)(\d*)? ?(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.wiki(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.ud(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.tts(?: |$)([\s\S]*)")
...
# kanged from Blank-x ;---;
@zein_ubot(outgoing=True, pattern=r"^\.imdb (.*)")
async def imdb(e):
    try:
...
@zein_ubot(outgoing=True, pattern=r"^\.trt(?: |$)([\s\S]*)")
...
@zein_ubot(pattern=r"\.lang (trt|tts) (.*)", outgoing=True)
...
@zein_ubot(outgoing=True, pattern=r"^\.yt(?: |$)(\d*)? ?(.*)")
...
@zein_ubot(outgoing=True, pattern=r"\.r(a|v( \d{0,4})?) (.*)")
