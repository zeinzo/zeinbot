...
@zein_ubot(outgoing=True, pattern=r"^\.magisk$")
...
@zein_ubot(outgoing=True, pattern=r"^\.device(?: |$)(\S*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.codename(?: |)([\S]*)(?: |)([\s\S]*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.specs(?: |)([\S]*)(?: |)([\s\S]*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.twrp(?: |$)(\S*)")
