...
@zein_ubot(outgoing=True, pattern=r"^\.compress(?: |$)(.*)")
async def _(event):
...
@zein_ubot(outgoing=True, pattern=r"^\.addzip(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.upzip(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.rmzip(?: |$)(.*)")
