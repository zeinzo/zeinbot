...
@zein_ubot(outgoing=True, pattern=r"^\.purge$")
...
@zein_ubot(outgoing=True, pattern=r"^\.purgeme")
...
@zein_ubot(outgoing=True, pattern=r"^\.del$")
...
@zein_ubot(outgoing=True, pattern=r"^\.edit")
...
@zein_ubot(outgoing=True, pattern=r"^\.sd")
