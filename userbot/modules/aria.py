...
@zein_ubot(outgoing=True, pattern=r"^\.amag(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.ator(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.aurl(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.aclear(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.apause(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.aresume(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.ashow(?: |$)(.*)")
