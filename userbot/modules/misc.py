...
@zein_ubot(outgoing=True, pattern=r"^\.random")
...
@zein_ubot(outgoing=True, pattern=r"^\.sleep ([0-9]+)$")
...
@zein_ubot(outgoing=True, pattern=r"^\.shutdown$")
...
@zein_ubot(outgoing=True, pattern=r"^\.restart$")
...
@zein_ubot(outgoing=True, pattern=r"^\.readme$")
async def reedme(e):
    await e.edit(
...
@zein_ubot(outgoing=True, pattern=r"^\.repeat (.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.repo$")
...
@zein_ubot(outgoing=True, pattern=r"^\.raw$")
async def raw(event):
...
@zein_ubot(outgoing=True, pattern=r"^\.send (.*)")
