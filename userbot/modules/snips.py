...
@zein_ubot(outgoing=True, pattern=r"^\$\w*", ignore_unsafe=True, disable_errors=True)
...
@zein_ubot(outgoing=True, pattern=r"^\.snip (\w*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.snips$")
...
@zein_ubot(outgoing=True, pattern=r"^\.remsnip (\w*)")
