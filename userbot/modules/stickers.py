...
@zein_ubot(outgoing=True, pattern=r"^\.kang")
async def kang(args):
...
@zein_ubot(outgoing=True, pattern=r"^\.stkrinfo$")
...
@zein_ubot(outgoing=True, pattern=r"^\.getsticker$")
...
@zein_ubot(outgoing=True, pattern=r"^\.findsticker (.*)")
