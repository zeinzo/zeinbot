...
@zein_ubot(outgoing=True, pattern=r"^\.notes$")
...
@zein_ubot(outgoing=True, pattern=r"^\.clear (\w*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.save (\w*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.rmbotnotes (.*)")
