...
@zein_ubot(outgoing=True, pattern=r"^\.filter ((@)?\w*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.stop ((@)?\w*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.rmbotfilters (.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.filters$")
