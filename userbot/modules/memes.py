...
from userbot.events import zein_ubot
...
@zein_ubot(outgoing=True, pattern=r"^\.(\w+)say (.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.coinflip(?: |$)(.*)")
...
@zein_ubot(pattern=r"^\.slap(?: |$)(.*)", outgoing=True)
async def who(event):
...
@zein_ubot(outgoing=True, pattern=r"^\.(yes|no|maybe|decide)$")
...
@zein_ubot(outgoing=True, pattern=r"^\.cry$")
async def cry(e):
    """y u du dis, i cry everytime !!"""
    await e.edit(choice(CRI))


@zein_ubot(outgoing=True, pattern=r"^\.insult$")
async def insult(e):
    """I make you cry !!"""
    await e.edit(choice(INSULT_STRINGS))


@zein_ubot(outgoing=True, pattern=r"^\.cp(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.vapor(?: |$)(.*)")
async def vapor(vpr):
    """Vaporize everything!"""
    reply_text = []
...
@zein_ubot(outgoing=True, pattern=r"^\.str(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.zal(?: |$)(.*)")
async def zal(zgfy):
...
@zein_ubot(outgoing=True, pattern=r"^\.hi$")
async def hoi(hello):
    """Greet everyone!"""
    await hello.edit(choice(HELLOSTR))


@zein_ubot(outgoing=True, pattern=r"^\.owo(?: |$)(.*)")
async def faces(owo):
    """UwU"""
...
@zein_ubot(outgoing=True, pattern=r"^\.react$")
async def react_meme(react):
    """Make your userbot react to everything."""
    await react.edit(choice(FACEREACTS))


@zein_ubot(outgoing=True, pattern=r"^\.shg$")
async def shrugger(shg):
    r"""¯\_(ツ)_/¯"""
    await shg.edit(choice(SHGS))


@zein_ubot(outgoing=True, pattern=r"^\.chase$")
async def police(chase):
    """Run boi run, i'm gonna catch you !!"""
    await chase.edit(choice(CHASE_STR))


@zein_ubot(outgoing=True, pattern=r"^\.run$")
async def runner_lol(run):
    """Run, run, RUNNN!"""
    await run.edit(choice(RUNS_STR))


@zein_ubot(outgoing=True, pattern=r"^\.metoo$")
async def metoo(hahayes):
    """Haha yes"""
    await hahayes.edit(choice(METOOSTR))


@zein_ubot(outgoing=True, pattern=r"^\.Oof$")
async def Oof(e):
    t = "Oof"
    for _ in range(15):
        t = t[:-1] + "of"
...
@zein_ubot(outgoing=True, pattern=r"^\.mock(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.clap(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.bt$")
...
@zein_ubot(outgoing=True, pattern=r"^\.f (.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.lfy (.*)")
...
@zein_ubot(pattern=r"^\.scam(?: |$)(.*)", outgoing=True)
...
@zein_ubot(pattern=r"^\.type(?: |$)(.*)", outgoing=True)
...
@zein_ubot(outgoing=True, pattern=r"^\.gz(?: |$)(.*)")
