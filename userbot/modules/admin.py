...
@zein_ubot(outgoing=True, pattern=r"^\.setgpic$")
...
@zein_ubot(outgoing=True, pattern=r"^\.promote(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.demote(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.ban(?: |$)(.*)")
async def ban(bon):
...
@zein_ubot(outgoing=True, pattern=r"^\.unban(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.mute(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.unmute(?: |$)(.*)")
...
@zein_ubot(incoming=True, disable_errors=True)
...
@zein_ubot(outgoing=True, pattern=r"^\.zombies(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.admins$")
...
@zein_ubot(outgoing=True, pattern=r"^\.pin(?: |$)(.*)")
async def pin(msg):
...
@zein_ubot(outgoing=True, pattern=r"^\.kick(?: |$)(.*)")
async def kick(usr):
...
@zein_ubot(outgoing=True, pattern=r"^\.users ?(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.usersdel ?(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.bots$")
