...
@zein_ubot(pattern=r"^\.gdauth(?: |$)", outgoing=True)
...
@zein_ubot(pattern=r"^\.gdreset(?: |$)", outgoing=True)
...
@zein_ubot(pattern=r"^\.gdlist(?: |$)(-l \d+)?(?: |$)?(.*)?(?: |$)", outgoing=True)
...
@zein_ubot(pattern=r"^\.gdf (mkdir|rm|chck) (.*)", outgoing=True)
...
@zein_ubot(pattern=r"^\.gdabort(?: |$)", outgoing=True)
...
@zein_ubot(pattern=r"^\.gd(?: |$)(.*)", outgoing=True)
...
@zein_ubot(pattern=r"^\.gdfset (put|rm)(?: |$)(.*)", outgoing=True)
...
@zein_ubot(outgoing=True, pattern=r"^\.gcl(?: |$)(.*)")
