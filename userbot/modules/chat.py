...
@zein_ubot(outgoing=True, pattern=r"^\.userid$")
...
@zein_ubot(outgoing=True, pattern=r"^\.link(?: |$)(.*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.chatid$")
async def chatidgetter(chat):
    """For .chatid, returns the ID of the chat you are in at that moment."""
    await chat.edit("Chat ID: `" + str(chat.chat_id) + "`")


@zein_ubot(outgoing=True, pattern=r"^\.log(?: |$)([\s\S]*)")
...
@zein_ubot(outgoing=True, pattern=r"^\.kickme$")
...
@zein_ubot(outgoing=True, pattern=r"^\.unmutechat$")
...
@zein_ubot(outgoing=True, pattern=r"^\.mutechat$")
...
@zein_ubot(outgoing=True, pattern=r"^s/")
...
@zein_ubot(outgoing=True, pattern=r"^\.regexninja (on|off)$")
