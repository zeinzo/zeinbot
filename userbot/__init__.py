...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL", "https://github.com/zeinzo/zeinbot.git"
)
UPSTREAM_REPO_BRANCH = os.environ.get("UPSTREAM_REPO_BRANCH", "Zeinzo-Userbot")
...
# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "Zeinzo-Userbot")
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**Zeinzo-Userbot v{ZEINZO_VERSION} is back up and running!**\n\n"
